...
(0, _helpers.onUpdateField)('iban', function (event) {
  ...
  _transfer2.formValidation.validateField('iban', trans.iban).then(function (result) {
...
(0, _helpers.onUpdateField)('name', function (event) {
  ...
  _transfer2.formValidation.validateField('name', trans.name).then(function (result) {
...
(0, _helpers.onUpdateField)('amount', function (event) {
  ...
  _transfer2.formValidation.validateField('amount', trans.amount).then(function (result) {
...
(0, _helpers.onUpdateField)('concept', function (event) {
  ...
  _transfer2.formValidation.validateField('concept', trans.concept).then(function (result) {
...
(0, _helpers.onUpdateField)('day', function (event) {
  ...
  _transfer2.formValidation.validateField('day', trans.day).then(function (result) {
...
(0, _helpers.onUpdateField)('month', function (event) {
  ...
  _transfer2.formValidation.validateField('month', trans.month).then(function (result) {
...
(0, _helpers.onUpdateField)('year', function (event) {
  ...
  _transfer2.formValidation.validateField('year', trans.year).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _transfer2.formValidation.validateField('email', trans.email).then(function (result) {
    (0, _helpers.onSetError)('email', result);
  });
});
(0, _helpers.onSubmitForm)('transfer-button', function () {
  _transfer2.formValidation.validateForm(trans).then(function (result) {
