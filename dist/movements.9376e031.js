...
var getMovementRow = function getMovementRow(movement) {
  ...
  var amountCell = document.createElement('td'); //amountCell.classList.add('align-right');
  ...
  var balanceCell = document.createElement('td'); //balanceCell.classList.add('align-right');
...
var mapMovementFromApiToVM = function mapMovementFromApiToVM(movementList) {
  return {
    id: movementList.id,
...
(0, _movements.getMovementsList)().then(function (movementList) {
  ...
  var viewModelMovementList = (0, _movements3.mapMovementListFromApiToVM)(movementList);
  (0, _movements2.addMovementRows)(viewModelMovementList);
});
},{"./movements.api":"pages/movements/movements.api.js","./movements.helpers":"pages/movements/movements.helpers.js","./movements.mappers":"pages/movements/movements.mappers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
